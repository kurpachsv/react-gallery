  ...
  _createClass(ViewMonitor, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["disableObserver", "disableActualImage", "tag", "children"]);

      var isVisible = this.state.isVisible;

      if (disableObserver) {
        return React__default.createElement(Tag, null, children(!disableActualImage));
      }
